...
function Footer() {
	return (
		<div className="footer">
			...
			<span>
				<h4 className="align-icon" style={{marginBlockStart: "0px"}}>You may check out the code on<GitHubIcon />Github</h4>
				<ul className="footer-links">
					<li>
						<a href="https://github.com/ahmednmourad/shoghly">Backend</a>
					</li>
					<li>
						<a href="https://github.com/EzzeldinKandeel/ivory">Frontend</a>
					</li>
					<li>
